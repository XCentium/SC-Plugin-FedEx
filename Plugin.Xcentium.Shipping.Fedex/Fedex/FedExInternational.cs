...
namespace Plugin.Xcentium.Shipping.Fedex.Fedex
{
    ...
    /// 
    /// </summary>
    public static class FedExInternational
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            request.RequestedShipment.Shipper = new RateWebServiceClient.RateServiceWebReference.Party
            {
                Address = new Address
                {
        ...
        {
            request.RequestedShipment.Recipient = new RateWebServiceClient.RateServiceWebReference.Party
            {
                Address = new Address
                {
        ...
        private static void SetCod(RateRequest request)
        {
            ...
            request.RequestedShipment.RequestedPackageLineItems[0].SpecialServicesRequested.CodDetail = new CodDetail
            {
                ...
                CodCollectionAmount = new RateWebServiceClient.RateServiceWebReference.Money
                {
                    Amount = 250,
